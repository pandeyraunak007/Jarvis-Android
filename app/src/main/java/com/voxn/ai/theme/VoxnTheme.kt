...
private val DarkColorScheme = darkColorScheme(
    primary = VoxnColors.electricBlue,
    secondary = VoxnColors.cyan,
    tertiary = VoxnColors.neonGreen,
    background = VoxnColors.backgroundDark,
    surface = VoxnColors.backgroundMid,
    onPrimary = Color.White,
    onSecondary = Color.White,
    onTertiary = Color.Black,
    onBackground = Color.White,
    onSurface = Color.White,
    error = VoxnColors.alertRed,
)

@Composable
fun VoxnTheme(content: @Composable () -> Unit) {
    MaterialTheme(
